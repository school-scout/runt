Gem::Specification.new do |s|
  ...
  s.date = %q{2008-12-11}
  s.description = 'Runt is a Ruby[http://www.ruby-lang.org/en/] implementation of select Martin Fowler patterns[http://www.martinfowler.com] specifically recurring events[http://martinfowler.com/apsupp/recurring.pdf].'
